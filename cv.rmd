...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _https://marianaarboleda.github.io/cv/_")
} else {
...
The source code is available [on github.com/nstrayer/cv](https://github.com/marianaarboleda/cv).
